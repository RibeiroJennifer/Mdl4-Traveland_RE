...
public class DestinosDAO {
	...
	//CREATE
		...
		public void create (Destinos destino) {
			...
			String sql= "INSERT INTO Destinos (nome_destino, pais, estado, cidade, preco) values (?, ?, ?, ?, ?)";
		...
		public void update(Destinos destino) {
			String sql = "UPDATE Destinos SET nome_destino = ?, pais = ?, estado = ?, cidade = ?, preco = ? WHERE ID_destino = ?";
