    ...
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top shadow-sm navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="index.jsp" id="home-menu">Início <span class="sr-only">(Página atual)</span></a>
          </li>
          <li class="nav-item">
  ...
  <main>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <div class="carousel-caption d-md-block">
            <h2>Disney Tóquio, Japão</h2>
            <p>Venha sonhar e explorar o castelo mágico da Cinderela, localizado na capital do Japão, Tóquio.</p>
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-md-block">
            <h2>Disney Paris, França </h2>
            <p>Venha sonhar e explorar o castelo mágico da Bela Adormecida, localizado na capital da França, Paris.</p>
            <button type="button" class="btn btn-primary">Visitar</button>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-md-block">
            ...
            <p>Venha sonhar e explorar o castelo mágico da Cinderela, localizado na cidade da Flórida|EUA, Orlando.</p>
            <button type="button" class="btn btn-primary">Visitar</button>
          </div>
        </div>
      </div>
            ...
            <div class="card-deck">
              <div class="card">
                ...
                <div class="card-body text-center">
                  <h5 class="card-title">Disney Paris, França <br>R$500,00 <br></h5>
                  <p class="card-text">Venha sonhar e explorar o castelo mágico da Bela Adormecida, localizado na
                    capital da França, Paris.</p>
              ...
              <div class="card">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="card-text">Venha sonhar e explorar o castelo mágico da Cinderela, localizado na cidade da
                    Flórida|EUA, Orlando.</p>
                  <button type="button" class="btn btn-secondary">Viajar</button>
                </div>
              </div>
              <div class="card">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="card-text">Venha sonhar e explorar o castelo mágico da Bela Adormecida, localizado na cidade
    ...
    <div id="promotions-area">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h3 class="main-title" style="margin-top: 20px; margin-bottom: -10px;">Promoções</h3>
            <hr>
          </div>
          <div class="row">
            <div class="card-deck">
              <div class="card">
                <img class="card-img-top" src="assets/img/DisneyParis.jpg" alt="Imagem de capa do card">
                <div class="card-body text-center">
                  <h5 class="card-title">Disney Paris, França<br>R$500,00 <br>
